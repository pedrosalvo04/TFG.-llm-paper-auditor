...
input_path = r'resultados evaluación audiciones gemini.md'
temp_output_path = r'scratch/resultados_formatted_temp.md'
...
print(f"Markdown formatting generated to {temp_output_path}")
